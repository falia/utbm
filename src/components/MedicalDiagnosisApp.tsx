...
export default function MedicalDiagnosisApp() {
  ...
  const availableClasses = ["Mild Dementia", "Moderate Dementia", "Non Demented", "Very mild Dementia"]
  ...
  const handleSubmitFeedback = async () => {
    if (!feedback.rating || !rawResult) return;
                ...
                <Grid item xs={12} lg={6}>
                  <Stack spacing={3}>
                        ...
                        {!feedback.submitted ? (
                          ...
                          <Alert severity="success" sx={{ borderRadius: 2 }}>
                            ...
                            <Typography variant="body2">
                              Votre évaluation nous aide à améliorer la précision du diagnostic.
                            </Typography>
                          </Alert>
                        )}
                      </CardContent>
                    ...
                    <Alert severity="info" sx={{ borderRadius: 2 }}>
                      ...
                      <Typography variant="body2">
                        Cet outil d'IA est destiné à assister les professionnels de santé et ne remplace pas 
                        un diagnostic médical professionnel. Consultez toujours un médecin spécialiste pour 
